...
<tr>
<td>
Hospital Id:&nbsp&nbsp&nbsp<label for="hosp_id">  </label>
</td>
<td>
Demand:&nbsp&nbsp&nbsp<label for="demand">  </label>
</td>
<td>
Blood Group:&nbsp&nbsp&nbsp<label for="blood_grp">  </label>
</td>
<br>

<?php 
$result = mysqli_query($con,"SELECT * FROM hospitaldemand");
